"""
Django settings for planejador_airbnb project.
...
# Diretório onde o Django coletará todos os arquivos estáticos em produção
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Diretórios adicionais onde o Django procurará arquivos estáticos
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Para arquivos globais (opcional)
]

# Configurações para encontrar arquivos estáticos em apps
STATICFILES_FINDERS = [
    'django.contrib.staticfiles.finders.FileSystemFinder',
    'django.contrib.staticfiles.finders.AppDirectoriesFinder',  # Esta linha é importante!
]
